...
public class DisplayController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (student != null) {
			...
			out.println("<td>SEMAILID</td>");
			out.println("<td>");
			out.println("<input type='text' name='semailid' value='" + student.getSemail() + "'/>");
			out.println("</td><br/>");
			out.println("</tr>");

			out.println("<tr>");
			out.println("<td>SPHNO</td>");
			out.println("<td>");
			out.println("<input type='text' name='sphno' value='" + student.getSphno() + "'/>");
			out.println("</td><br/>");
			out.println("</tr>");

			out.println("<tr>");
			
			out.println("<td>SADARNO</td>");
			out.println("<td>");
			out.println("<input type='text' name='sadharno' value='" + student.getSadharno() + "'/>");
			out.println("</td><br/>");
			out.println("</tr>");

			out.println("<tr>");
			
			out.println("<td>SBANKACC</td>");
			out.println("<td>");
			out.println("<input type='text' name='sbankacc' value='" + student.getSbankacc() + "'/>");
			out.println("</td><br/>");
			out.println("</tr>");
